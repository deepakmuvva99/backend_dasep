...
exports.createSchedule = async (req, res) => {
    ...
    const newSchedule = await examSchedulesService.createSchedule({ title, class_id, subject_id, exam_datetime }, createdByUserId);
...
exports.updateSchedule = async (req, res) => {
    ...
    const updated = await examSchedulesService.updateSchedule(req.params.schedule_id, { title, exam_datetime });
    return successResponse(res, updated);
};

exports.deleteSchedule = async (req, res) => {
    await examSchedulesService.deleteSchedule(req.params.schedule_id);
